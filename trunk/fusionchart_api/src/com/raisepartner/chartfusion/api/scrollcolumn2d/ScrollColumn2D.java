 ...
 */
package com.raisepartner.chartfusion.api.scrollcolumn2d;

public class ScrollColumn2D extends com.raisepartner.chartfusion.api.Chart {
	 ...
	 * Description :
	 * This attribute lets you control how the number of columns to show 
	 * in the visible area of the scroll pane.
For example, if you're 
	 * plotting a chart with 10 columns each in 3 dataset, totalling to 30 
	 * columns, and you wish to show only 10 columns in the visible area, set
	 *  this attribute as 10. You would now see only 10 columns in the chart 
	 * - rest of the columns would be visible upon scrolling. 
If you want to
	 *  show all the columns on the chart irrespective of the number of data 
	 * points in your XML data document, set this attribute as 0. 
	 */
...
Plot 
	...
	public void setLegendPadding(String value) {
        ...
        /**
         * @see com.raisepartner.chartfusion.api.scrollcolumn2d.Dataset
         */
        ...
        /**
         * @see com.raisepartner.chartfusion.api.scrollcolumn2d.Categories
         */
        ...
        /**
         * @see com.raisepartner.chartfusion.api.scrollcolumn2d.TrendLines
         */
