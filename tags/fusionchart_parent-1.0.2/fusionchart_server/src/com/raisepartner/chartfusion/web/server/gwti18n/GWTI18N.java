 ...
 */
package com.raisepartner.chartfusion.web.server.gwti18n;
...
public class GWTI18N {
	...
	private static Object createProxy(Class itf, String lang) throws IOException {
	...
	private static class GenericMessagesServer implements InvocationHandler {
		...
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			...
			if (k == null) {
				...
				String s = properties.getProperty(k.value());
				if (s == null) {
