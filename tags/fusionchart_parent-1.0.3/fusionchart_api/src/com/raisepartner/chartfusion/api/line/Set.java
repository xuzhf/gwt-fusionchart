 ...
 */
package com.raisepartner.chartfusion.api.line;
...
public class Set extends com.raisepartner.chartfusion.api.Set {
	...
	public final static String PARAMETER_SHOWNAME = "showName";
	...
	public final static String PARAMETER_HOVERTEXT = "hoverText";
	 ...
	 * Range value:
	 * Description :
	 *   This attribute determines the name for the data item. The name
	 *  appears on the x-axis of chart.
	 */
	 ...
	 * Range value: 0/1
	 * Description :
	 * You can individually opt to show/hide names of individual data
	 * items using this attribute.
	 */
	public void setShowName(String value) {
		setAttribute(PARAMETER_SHOWNAME, value);
	}
	 ...
	 * Range value: 0-100
	 * Description :
	 * Sometimes, you might just want to show the abbreviated names on the x-axis
     *  (to avoid cluttering or to make the chart look more legible). However,
     * you still have the option of showing the full name as tool tip using this
     *  attribute. Like, in our example, we're showing the abbreviated form "Jan"
     * on our x-axis, but the full word "January" is shown as the tool tip.
	 */
	public void setHoverText(String value) {
		setAttribute(PARAMETER_HOVERTEXT, value);
	}
}
