...
public abstract class Style extends Node {

	public final static String PARAMETER_name = "name";
	public final static String PARAMETER_type = "type";
	
	public Style(String styleName, String type) {
		super("style");
		setAttribute(PARAMETER_name, styleName);
		setAttribute(Style.PARAMETER_type, type);
	}
