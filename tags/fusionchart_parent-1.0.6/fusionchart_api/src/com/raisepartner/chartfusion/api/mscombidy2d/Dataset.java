...
public class Dataset extends com.raisepartner.chartfusion.api.Dataset {
	...
	/**
	 * Type: String 
	 * Range value: COLUMN, AREA or LINE 
	 * Description :
	 * This attribute defines what the particular data-set will be 
	 * plotted as. Valid values are COLUMN, AREA or LINE. 
	 */
	 ...
	 * P (primary) or S (secondary). Primary data-sets are drawn against the 
	 * left y-axis and the secondary against the right-axis. 
	 */
	 ...
	 * Range value: 0/1 
	 * Description :
	 * Whether to show the border of this data-set (area or column only)?
	 *  
	 */
	 ...
	 * Range value: 
	 * Description :
	 * Color for data plot border of this data-set (area or column only) 
	 */
	 ...
	 * Description :
	 * Thickness for data plot border of this data-set (area or column 
	 * only) 
	 */
	 ...
	 * Range value: 0-100 
	 * Description :
	 * Alpha for data plot border of this data-set (area or column only) 
	 */
	...
	public void setLineDashGap(String value) {
        ...
        /**
         * @see com.raisepartner.chartfusion.api.mscombidy2d.Set
         */
