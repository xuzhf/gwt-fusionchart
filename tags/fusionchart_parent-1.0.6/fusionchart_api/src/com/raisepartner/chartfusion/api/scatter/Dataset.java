...
public class Dataset extends com.raisepartner.chartfusion.api.Dataset {
	...
	public final static String PARAMETER_DRAWLINE = "drawLine";
	 ...
	 * Range value: 0/1 
	 * Description :
	 * You can opt to connect the scatter points of any dataset using 
	 * lines. This attribute helps you configure that.
	 */
	public void setDrawLine(String value) {
		setAttribute(PARAMETER_DRAWLINE, value);
	}
	 ...
	 * Range value: 0/1 
	 * Description :
	 * Configuration whether to show the lines connecting the scatter 
	 * points as dash?
	 */
	...
	public void setLineDashGap(String value) {
        ...
        /**
         * @see com.raisepartner.chartfusion.api.scatter.Set
         */
